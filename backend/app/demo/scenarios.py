...
DEMO_ACCOUNTS = [
    DemoAccount(
        ...
        business_name="Acme Industrial Corp",
    ),
    DemoAccount(
    ...
    DemoAccount(
        ...
        check_frequency=8,
        returned_items=0,
        holder_name="David Williams",
        business_name="Williams Property Management LLC",
    ),
    DemoAccount(
    ...
    DemoAccount(
        ...
        check_frequency=25,
        returned_items=0,
        holder_name="James Davis",
        business_name="Davis Industries Inc",
    ),
    DemoAccount(
        ...
        business_name="Garcia Landscaping Services",
    ),
    DemoAccount(
    ...
    DemoAccount(
        ...
        check_frequency=12,
        returned_items=0,
        holder_name="Riverside Community Foundation",
        business_name="Riverside Community Foundation",
    ),
]
