...
from app.integrations.adapters.simulated.images import render_check_image
...
class MockAdapter(IntegrationAdapter):
    ...
    def _generate_check_image(
        ...
        """Generate a mock check image (delegates to the shared renderer)."""
        return render_check_image(image_id, is_front=is_front, width=width, height=height)
